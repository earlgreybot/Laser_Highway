...
function events_post_type() {
	...
	$labels = array(
		...
		'featured_image'        => __( 'Event Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set event featured image', 'text_domain' ),
		'remove_featured_image' => __( 'Remove event featured image', 'text_domain' ),
		'use_featured_image'    => __( 'Use as event featured image', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Information about each Laser Highway event', 'text_domain' ),
		'labels'                => $labels,
